...
public class DataProviders {
	private static  final String FILE_PATH = System.getProperty("user.dir")+"/src/test/resources/tesdata/TestData.xlsx";
/**/
	@DataProvider(name="validLoginData")
	public static synchronized Object[][] validLoginData(){
		return getSheetData("validLoginData");
	}
	
	@DataProvider(name="inValidLoginData")
	public static synchronized Object[][] inValidLoginData(){
		return getSheetData("inValidLoginData");
	}
	
	@DataProvider(name="emplVerification")
	public static synchronized Object[][] emplVerification(){
